...
export function getCashierDashboardData() {
  return {
    ...
    recentTransactions: [
      { id: 42, sequenceNumber: 42, customerName: "Ibu Sari Wulandari", amount: 150000, paymentStatus: "confirmed" },
      { id: 41, sequenceNumber: 41, customerName: "Pak Budi Santoso", amount: 275000, paymentStatus: "draft" },
      { id: 40, sequenceNumber: 40, customerName: "Ibu Ratna Kusuma", amount: 90000, paymentStatus: "confirmed" },
      { id: 39, sequenceNumber: 39, customerName: "Pak Andi Prasetyo", amount: 420000, paymentStatus: "cancelled" },
      { id: 38, sequenceNumber: 38, customerName: "Ibu Dewi Lestari", amount: 185000, paymentStatus: "draft" },
    ],
  };
}
